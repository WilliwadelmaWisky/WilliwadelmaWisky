...
<p align="justify">
  Many times I found myself wondering how amazing mods people have managed to build while playing video games. I had a little dream that maybe one day I would be able to build something like that as well. My interests in modding kept growing. Then one day while playing Ark Survival Evolved (modded) I decided to finally try to make a simple mod myself. I began searhing how does one make mods for ARK. I came across Ark Dev Kit, which was powered by Unreal Engine, and managed to make my own mod after trial and error. There was actually very little resources available on how the dev kit works at the time so I lost interest on it quite quickly. Also the fact that the dev kit ran extremely slowly on my machine encouraged that decision. Naturally my interests moved from the dev kit to the Unreal Engine itself, which was an engine to develop games, and so my journey as a "game developer" had started.
</p>
...
<p align="justify">
  I wanted to build myself a simple static website. I found out that I needed to learn two new languages for that, HTML and CSS. Luckily the syntax of both languages was very straight forward so it did not take too long to learn the basics. I was able to make somewhat eye-pleasing results so I thought that maybe I should invest a little more time on learning frontend development. Some time later I began searching on how to render dynamic data on the website. I found out I needed to learn yet another new language, JavaScript. Javascript was such a weird language compared to C# but luckily it had little similarities to Python like the dynamic typing. I was able to understand enough to make something work without too many error message in the console. I decided to search if there was a better and easier way. Firstly I came across a library called a JQuery. It had many nice functions to shorten the repeating JavaScript code and was very easy to enable. I also came across something called TypeScript.
</p>
