...
## Starting game development with the already familiar Unreal Engine 4
...
![Unity Engine](https://img.shields.io/badge/Unity-100000?style=flat&logo=unity&logoColor=white)
...
## Starting to learn frontend web development
...
## Trying out desktop application development
...
<p align="justify">
  My journey circles back to its roots with C# once again. Eventually I drfited away from C# to Java once again. Now I have been using Java for developing desktop applications and have not really looked back. I absolutely love to work with JavaFX. But of course I wanted to learn more so could not stop my journey on the JavaFX. I decided to try what kinda frameworks Python has to offer for building desktop applications.
</p>
...
## Trying to create utility scripts and libraries
![Rust](https://img.shields.io/badge/Rust-323330?style=flat&logo=rust&logoColor=E95420)
...
## Trying out Python for desktop applications
...
## Looking for more control with desktop applications and starting to learn graphics 
